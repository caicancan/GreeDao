package com.brioal.ttstest.dao;
...
public class GoodsDao extends AbstractDao<Goods, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Issale = new Property(3, boolean.class, "issale", false, "ISSALE");
    }
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"GOODS\" (" + //
                ...
                "\"ISSALE\" INTEGER NOT NULL );"); // 3: issale
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Goods entity) {
        ...
        stmt.bindLong(4, entity.getIssale() ? 1L: 0L);
    }
    ...
    public Goods readEntity(Cursor cursor, int offset) {
        Goods entity = new Goods( //
            ...
            cursor.getShort(offset + 3) != 0 // issale
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Goods entity, int offset) {
        ...
        entity.setIssale(cursor.getShort(offset + 3) != 0);
     }
